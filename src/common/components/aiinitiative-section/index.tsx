import { SectionTypes } from "@/common/types/aiinitiativesection.types";
import Image from "next/image";

export const SectionGenerator: React.FC<SectionTypes> = ({
    image,
    subheader,
    header,
    textColor,
    ...
    return (
        <div
            ...
            <div
                ...
                <p
                    className={`text-xl md:text-6xl font-bold w-full ${textColor ? `md:w-[50vw]` : `md:w-4/5`} mt-10`}>
                    {header}
                </p>
